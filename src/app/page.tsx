              ...
              {campaigns.map((campaign) => {
                ...
                return (
                  <div key={campaign.id} className="card-warm overflow-hidden hover:shadow-xl transition">
                    <div className="p-4">
                      <h3 className="font-semibold text-base text-primary-900 mb-3">{campaign.title}</h3>
                    ...
                    <div className="bg-gradient-to-r from-primary-50 to-warm-50 px-4 py-2 border-t border-primary-200">
                      <Link href="/login" className="text-primary-700 hover:text-primary-800 text-xs font-semibold">
                        {t('loginToContribute')}
                      </Link>
                    </div>
                  </div>
