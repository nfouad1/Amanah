...
export const translations = {
  en: {
    ...
    campaignCreatedSuccess: 'Campaign created successfully! It needs 3 votes to become active.',
    campaignLimitReached: 'You already have 2 active or pending campaigns. Complete or cancel one before creating a new one.',
    campaignNeedsVotes: 'This campaign requires community votes',
    campaignNeedsVotesDesc: 'Your campaign will be visible to group members immediately, but needs 3 votes before contributions can be made.',
    ...
    viewerRequestGroupCreation: 'Request to Create Your Own Group',
    viewerGroupCreationBannerText: 'Want to start a family group? Send a request to the platform admin.',
    viewerGroupCreationRequestSent: 'Your request to create a group has been sent to the admin.',
    viewerGroupCreationPending: 'Your group creation request is pending admin approval.',
    groupCreationRequestMessage: 'Tell us why you want to create a group (optional)',
    ...
    notifGroupCreationRequest: '{userName} wants to create a family group on the platform',
    notifGroupCreationApproved: 'Your request to create a group was approved! You can now create groups.',
    notifGroupCreationRejected: 'Your request to create a group was not approved.',
    ...
    reportOrganizationName: 'Amanah',
    reportId: 'Report ID',
    reportGeneratedAt: 'Generated At',
    reportDateRange: 'Date Range',
    reportMemberName: 'Member Name',
    reportMemberEmail: 'Member Email',
    ...
    reportTotal: 'Total',
    reportDisclaimer: 'This report is for informational purposes only. Please consult with a tax professional regarding deductibility.',
    reportCampaignTitle: 'Campaign Title',
    reportDescription: 'Description',
    reportTargetAmount: 'Target Amount',
    reportCurrentAmount: 'Current Amount',
    reportStatus: 'Status',
    reportStartDate: 'Start Date',
    reportEndDate: 'End Date',
    reportContributors: 'Contributors',
    reportAverageContribution: 'Average Contribution',
    reportFundingPercentage: 'Funding Percentage',
    reportAggregateStats: 'Aggregate Statistics',
    reportTotalCampaigns: 'Total Campaigns',
    reportTotalContributions: 'Total Contributions',
    reportTotalAmount: 'Total Amount',
    reportAverageCampaignSize: 'Average Campaign Size',
    reportUniqueContributors: 'Unique Contributors',
    reportPage: 'Page',
    reportOf: 'of',
    reportNoContributions: 'No contributions found for the specified date range',
    reportSelectDateRange: 'Select Date Range',
    reportStartDateLabel: 'Start Date',
    reportEndDateLabel: 'End Date',
    reportAllTime: 'All Time',
    reportCurrentYear: 'Current Year',
    reportLastYear: 'Last Year',
    reportCustomRange: 'Custom Range',
    reportSelectCampaigns: 'Select Campaigns',
    reportAllCampaigns: 'All Campaigns',
    reportFilterByGroup: 'Filter by Group',
    reportFilterByStatus: 'Filter by Status',
    reportGenerating: 'Generating report...',
    reportCampaignReportTitle: 'Campaign Report',
    reportGenerationError: 'Failed to generate report. Please try again.',
    generatingReport: 'Generating...',
    donationReportDesc: 'Download a PDF of your contributions for tax purposes.',
    campaignReportDesc: 'Generate a comprehensive PDF report of all campaigns.',
  ...
  ar: {
    ...
    campaignCreatedSuccess: 'تم إنشاء الحملة بنجاح! تحتاج إلى 3 أصوات لتصبح نشطة.',
    campaignLimitReached: 'لديك بالفعل حملتان نشطتان أو معلقتان. أكمل أو ألغِ إحداهما قبل إنشاء حملة جديدة.',
    campaignNeedsVotes: 'تتطلب هذه الحملة أصوات المجتمع',
    campaignNeedsVotesDesc: 'ستكون حملتك مرئية لأعضاء المجموعة فوراً، لكنها تحتاج إلى 3 أصوات قبل قبول المساهمات.',
    ...
    viewerRequestGroupCreation: 'طلب إنشاء مجموعتك الخاصة',
    viewerGroupCreationBannerText: 'هل تريد إنشاء مجموعة عائلية؟ أرسل طلباً إلى مسؤول المنصة.',
    viewerGroupCreationRequestSent: 'تم إرسال طلبك لإنشاء مجموعة إلى المسؤول.',
    viewerGroupCreationPending: 'طلب إنشاء مجموعتك قيد انتظار موافقة المسؤول.',
    groupCreationRequestMessage: 'أخبرنا لماذا تريد إنشاء مجموعة (اختياري)',
    ...
    notifGroupCreationRequest: '{userName} يريد إنشاء مجموعة عائلية على المنصة',
    notifGroupCreationApproved: 'تمت الموافقة على طلبك لإنشاء مجموعة! يمكنك الآن إنشاء مجموعات.',
    notifGroupCreationRejected: 'لم تتم الموافقة على طلبك لإنشاء مجموعة.',
    ...
    reportGenerationFailed: 'فشل في إنشاء التقرير',
    
    // Report Translations
    reportTitle: 'تقرير التبرعات',
    reportOrganizationName: 'أمانة',
    reportId: 'رقم التقرير',
    reportGeneratedAt: 'تاريخ الإنشاء',
    reportDateRange: 'النطاق الزمني',
    reportMemberName: 'اسم العضو',
    reportMemberEmail: 'البريد الإلكتروني للعضو',
    reportContributions: 'المساهمات',
    reportDate: 'التاريخ',
    reportCampaign: 'الحملة',
    reportBeneficiary: 'المستفيد',
    reportAmount: 'المبلغ',
    reportCurrency: 'العملة',
    reportTotal: 'الإجمالي',
    reportDisclaimer: 'هذا التقرير لأغراض إعلامية فقط. يرجى استشارة متخصص ضرائب بشأن قابلية الخصم.',
    reportCampaignTitle: 'عنوان الحملة',
    reportDescription: 'الوصف',
    reportTargetAmount: 'المبلغ المستهدف',
    reportCurrentAmount: 'المبلغ الحالي',
    reportStatus: 'الحالة',
    reportStartDate: 'تاريخ البدء',
    reportEndDate: 'تاريخ الانتهاء',
    reportContributors: 'المساهمون',
    reportAverageContribution: 'متوسط المساهمة',
    reportFundingPercentage: 'نسبة التمويل',
    reportAggregateStats: 'الإحصائيات الإجمالية',
    reportTotalCampaigns: 'إجمالي الحملات',
    reportTotalContributions: 'إجمالي المساهمات',
    reportTotalAmount: 'المبلغ الإجمالي',
    reportAverageCampaignSize: 'متوسط حجم الحملة',
    reportUniqueContributors: 'المساهمون الفريدون',
    reportPage: 'صفحة',
    reportOf: 'من',
    reportNoContributions: 'لم يتم العثور على مساهمات للنطاق الزمني المحدد',
    reportSelectDateRange: 'اختر النطاق الزمني',
    reportStartDateLabel: 'تاريخ البدء',
    reportEndDateLabel: 'تاريخ الانتهاء',
    reportAllTime: 'كل الأوقات',
    reportCurrentYear: 'السنة الحالية',
    reportLastYear: 'السنة الماضية',
    reportCustomRange: 'نطاق مخصص',
    reportSelectCampaigns: 'اختر الحملات',
    reportAllCampaigns: 'جميع الحملات',
    reportFilterByGroup: 'تصفية حسب المجموعة',
    reportFilterByStatus: 'تصفية حسب الحالة',
    reportGenerating: 'جاري إنشاء التقرير...',
    reportCampaignReportTitle: 'تقرير الحملة',
    reportGenerationError: 'فشل في إنشاء التقرير. يرجى المحاولة مرة أخرى.',
    generatingReport: 'جاري الإنشاء...',
    donationReportDesc: 'تحميل ملف PDF لمساهماتك لأغراض ضريبية.',
    campaignReportDesc: 'إنشاء تقرير PDF شامل لجميع الحملات.',
  ...
  sv: {
    ...
    campaignCreatedSuccess: 'Kampanj skapad! Den behöver 3 röster för att aktiveras.',
    campaignLimitReached: 'Du har redan 2 aktiva eller väntande kampanjer. Slutför eller avbryt en innan du skapar en ny.',
    campaignNeedsVotes: 'Kampanjen kräver röster från gruppen',
    campaignNeedsVotesDesc: 'Din kampanj syns direkt för gruppmedlemmar, men behöver 3 röster innan bidrag kan göras.',
    ...
    viewerRequestGroupCreation: 'Begär att skapa din egen grupp',
    viewerGroupCreationBannerText: 'Vill du starta en familjegrupp? Skicka en begäran till plattformsadmin.',
    viewerGroupCreationRequestSent: 'Din begäran om att skapa en grupp har skickats till admin.',
    viewerGroupCreationPending: 'Din begäran om att skapa en grupp väntar på admin-godkännande.',
    groupCreationRequestMessage: 'Berätta varför du vill skapa en grupp (valfritt)',
    ...
    notifGroupCreationRequest: '{userName} vill skapa en familjegrupp på plattformen',
    notifGroupCreationApproved: 'Din begäran om att skapa en grupp godkändes! Du kan nu skapa grupper.',
    notifGroupCreationRejected: 'Din begäran om att skapa en grupp godkändes inte.',
    ...
    donationReport: 'Donationsrapport',
    campaignReport: 'Kampanjrapport',
    downloadReport: 'Ladda ner rapport',
    reportGenerated: 'Rapport genererad',
    reportGenerationFailed: 'Misslyckades generera rapport',
    
    // Report Translations
    reportTitle: 'Donationsrapport',
    reportOrganizationName: 'Amanah',
    reportId: 'Rapport-ID',
    reportGeneratedAt: 'Genererad',
    reportDateRange: 'Datumintervall',
    reportMemberName: 'Medlemsnamn',
    reportMemberEmail: 'Medlems e-post',
    reportContributions: 'Bidrag',
    reportDate: 'Datum',
    reportCampaign: 'Kampanj',
    reportBeneficiary: 'Mottagare',
    reportAmount: 'Belopp',
    reportCurrency: 'Valuta',
    reportTotal: 'Totalt',
    reportDisclaimer: 'Denna rapport är endast för informationsändamål. Vänligen konsultera en skatterådgivare angående avdragsrätt.',
    reportCampaignTitle: 'Kampanjtitel',
    reportDescription: 'Beskrivning',
    reportTargetAmount: 'Målbelopp',
    reportCurrentAmount: 'Nuvarande belopp',
    reportStatus: 'Status',
    reportStartDate: 'Startdatum',
    reportEndDate: 'Slutdatum',
    reportContributors: 'Bidragsgivare',
    reportAverageContribution: 'Genomsnittligt bidrag',
    reportFundingPercentage: 'Finansieringsprocent',
    reportAggregateStats: 'Sammanlagd statistik',
    reportTotalCampaigns: 'Totalt antal kampanjer',
    reportTotalContributions: 'Totalt antal bidrag',
    reportTotalAmount: 'Totalt belopp',
    reportAverageCampaignSize: 'Genomsnittlig kampanjstorlek',
    reportUniqueContributors: 'Unika bidragsgivare',
    reportPage: 'Sida',
    reportOf: 'av',
    reportNoContributions: 'Inga bidrag hittades för det angivna datumintervallet',
    reportSelectDateRange: 'Välj datumintervall',
    reportStartDateLabel: 'Startdatum',
    reportEndDateLabel: 'Slutdatum',
    reportAllTime: 'All tid',
    reportCurrentYear: 'Innevarande år',
    reportLastYear: 'Förra året',
    reportCustomRange: 'Anpassat intervall',
    reportSelectCampaigns: 'Välj kampanjer',
    reportAllCampaigns: 'Alla kampanjer',
    reportFilterByGroup: 'Filtrera efter grupp',
    reportFilterByStatus: 'Filtrera efter status',
    reportGenerating: 'Genererar rapport...',
    reportCampaignReportTitle: 'Kampanjrapport',
    reportGenerationError: 'Misslyckades att generera rapport. Försök igen.',
    generatingReport: 'Genererar...',
    donationReportDesc: 'Ladda ner en PDF av dina bidrag för skatteändamål.',
    campaignReportDesc: 'Generera en heltäckande PDF-rapport över alla kampanjer.',
    reportLanguage: 'Rapportspråk',
