...
export const translations = {
  en: {
    ...
    roleMember: 'Member',
    roleViewer: 'Viewer',
    roleDescAdmin: 'Full access to all features and user management',
    roleDescContributor: 'Can create campaigns, vote, and contribute',
    roleDescMember: 'Can vote and contribute to campaigns',
    roleDescViewer: 'Can only view campaigns and statistics',
    roleDescContributorInvite: 'Can create campaigns, vote, and contribute. 5 invites.',
    roleDescMemberInvite: 'Can vote and contribute to campaigns. 3 invites.',
    roleDescViewerInvite: 'Can only view campaigns and statistics. 0 invites.',
    selectRoleForInvite: 'Select Role for Invited User',
    changeRole: 'Change Role',
    selectNewRole: 'Select a new role for this user',
    noPermissionCreateCampaign: 'You do not have permission to create campaigns. Only Contributors and Admins can create campaigns.',
    noPermissionCreateGroup: 'You do not have permission to create groups. Only Admins can create groups.',
    noPermissionContribute: 'You do not have permission to contribute. Viewers can only view campaigns.',
    noPermissionVote: 'You do not have permission to vote. Viewers cannot vote on campaigns.',
    noPermissionCreateInvite: 'You do not have permission to create invites. Viewers cannot create invites.',
  ...
  ar: {
    ...
    roleMember: 'عضو',
    roleViewer: 'مشاهد',
    roleDescAdmin: 'وصول كامل لجميع الميزات وإدارة المستخدمين',
    roleDescContributor: 'يمكنه إنشاء الحملات والتصويت والمساهمة',
    roleDescMember: 'يمكنه التصويت والمساهمة في الحملات',
    roleDescViewer: 'يمكنه فقط عرض الحملات والإحصائيات',
    roleDescContributorInvite: 'يمكنه إنشاء الحملات والتصويت والمساهمة. 5 دعوات.',
    roleDescMemberInvite: 'يمكنه التصويت والمساهمة في الحملات. 3 دعوات.',
    roleDescViewerInvite: 'يمكنه فقط عرض الحملات والإحصائيات. 0 دعوات.',
    selectRoleForInvite: 'اختر دور المستخدم المدعو',
    changeRole: 'تغيير الدور',
    selectNewRole: 'اختر دوراً جديداً لهذا المستخدم',
    noPermissionCreateCampaign: 'ليس لديك إذن لإنشاء الحملات. يمكن للمساهمين والمسؤولين فقط إنشاء الحملات.',
    noPermissionCreateGroup: 'ليس لديك إذن لإنشاء المجموعات. يمكن للمسؤولين فقط إنشاء المجموعات.',
    noPermissionContribute: 'ليس لديك إذن للمساهمة. يمكن للمشاهدين فقط عرض الحملات.',
    noPermissionVote: 'ليس لديك إذن للتصويت. لا يمكن للمشاهدين التصويت على الحملات.',
    noPermissionCreateInvite: 'ليس لديك إذن لإنشاء الدعوات. لا يمكن للمشاهدين إنشاء الدعوات.',
    ...
    startImmediatelyDesc: 'ستكون الحملة نشطة على الفور دون الحاجة إلى أصوات',
    campaignApprovalSetting: 'موافقة الحملة',
    ...
    viewAll: 'عرض الكل',
    filterAll: 'الكل',
    filterCampaigns: 'الحملات',
    filterContributions: 'المساهمات',
    filterInvites: 'الدعوات',
    filterRoles: 'الأدوار',
    ...
    notifCampaignGoalReached: "الحملة '{campaignTitle}' وصلت إلى هدفها!",
    notifCampaignVote: "{userName} صوت لصالح '{campaignTitle}'",
    notifCampaignActivated: "الحملة '{campaignTitle}' أصبحت نشطة الآن",
    notifCampaignDeleted: "تم حذف الحملة '{campaignTitle}'",
    notifRoleChanged: "تم تغيير دورك من {oldRole} إلى {newRole}",
    notifGroupInvited: "تمت دعوتك للانضمام إلى {groupName}",
    notifInviteAccepted: "{userName} قبل دعوتك",
    notifInviteExpired: "انتهت صلاحية رمز الدعوة الخاص بك",
    notifContributionReceived: "{userName} ساهم بمبلغ {amount} في حملتك",
    notifContributionAnonymous: "مساهمة مجهولة بمبلغ {amount} في حملتك",
  },
  sv: {
    // Landing Page
    appName: 'Sanad',
    ...
    roleContributor: 'Bidragsgivare',
    roleMember: 'Medlem',
    roleViewer: 'Tittare',
    roleDescAdmin: 'Full åtkomst till alla funktioner och användarhantering',
    roleDescContributor: 'Kan skapa kampanjer, rösta och bidra',
    roleDescMember: 'Kan rösta och bidra till kampanjer',
    roleDescViewer: 'Kan endast visa kampanjer och statistik',
    roleDescContributorInvite: 'Kan skapa kampanjer, rösta och bidra. 5 inbjudningar.',
    roleDescMemberInvite: 'Kan rösta och bidra till kampanjer. 3 inbjudningar.',
    roleDescViewerInvite: 'Kan endast visa kampanjer och statistik. 0 inbjudningar.',
    selectRoleForInvite: 'Välj roll för inbjuden användare',
    changeRole: 'Ändra roll',
    selectNewRole: 'Välj en ny roll för denna användare',
    noPermissionCreateCampaign: 'Du har inte behörighet att skapa kampanjer. Endast bidragsgivare och administratörer kan skapa kampanjer.',
    noPermissionCreateGroup: 'Du har inte behörighet att skapa grupper. Endast administratörer kan skapa grupper.',
    noPermissionContribute: 'Du har inte behörighet att bidra. Tittare kan endast visa kampanjer.',
    noPermissionVote: 'Du har inte behörighet att rösta. Tittare kan inte rösta på kampanjer.',
    noPermissionCreateInvite: 'Du har inte behörighet att skapa inbjudningar. Tittare kan inte skapa inbjudningar.',
    ...
    startImmediatelyDesc: 'Kampanjen blir aktiv direkt utan att behöva röster',
    campaignApprovalSetting: 'Kampanjgodkännande',
    ...
    deleteNotification: 'Radera',
    noNotifications: 'Inga notifikationer ännu',
    viewAll: 'Visa alla',
    filterAll: 'Alla',
    filterCampaigns: 'Kampanjer',
    filterContributions: 'Bidrag',
    filterInvites: 'Inbjudningar',
    filterRoles: 'Roller',
    ...
    notifCampaignContribution: "{userName} bidrog med {amount} till '{campaignTitle}'",
    notifCampaignGoalReached: "Kampanjen '{campaignTitle}' nådde sitt mål!",
    notifCampaignVote: "{userName} röstade för '{campaignTitle}'",
    notifCampaignActivated: "Kampanjen '{campaignTitle}' är nu aktiv",
    notifCampaignDeleted: "Kampanjen '{campaignTitle}' raderades",
    notifRoleChanged: "Din roll ändrades från {oldRole} till {newRole}",
    notifGroupInvited: "Du blev inbjuden att gå med i {groupName}",
    notifInviteAccepted: "{userName} accepterade din inbjudan",
    notifInviteExpired: "Din inbjudningskod har gått ut",
    notifContributionReceived: "{userName} bidrog med {amount} till din kampanj",
    notifContributionAnonymous: "Anonymt bidrag på {amount} till din kampanj",
  },
};
